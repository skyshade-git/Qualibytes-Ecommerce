...
pipeline {
    ...
    environment {
        ...
        DOCKER_IMAGE_NAME = 'skyshadedocker/qbshop'
        DOCKER_MIGRATION_IMAGE_NAME = 'skyshadedocker/qbshop'
    ...
    stages {
        ...
        stage('Clone Repository') {
            steps {
                script {
                    clone("https://github.com/skyshade-git/Qualibytes-Ecommerce.git", "dev")
                }
            }
        }
